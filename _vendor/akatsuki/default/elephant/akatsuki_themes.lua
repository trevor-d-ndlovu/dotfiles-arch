--
-- Dynamic Akatsuki Theme Menu for Elephant/Walker
--
Name = "akatsukithemes"
NamePretty = "Akatsuki Themes"
...
function GetEntries()
  local entries = {}
  local user_theme_dir = os.getenv("HOME") .. "/.config/akatsuki/themes"
  local akatsuki_path = os.getenv("AKATSUKI_PATH") or ""
  local default_theme_dir = akatsuki_path .. "/themes"
      ...
      if theme_name and not seen_themes[theme_name] then
        ...
        if preview_path and preview_path ~= "" then
          ...
          table.insert(entries, {
            ...
            PreviewType = "file",
            Actions = {
              activate = "akatsuki-theme-set " .. theme_name,
            },
          })
        end
      end
