...
class TranscodeAction(GObject.GObject, Nautilus.MenuProvider):
    def _launch_transcode(self, paths):
        wrapper = shutil.which("akatsuki-launch-floating-terminal-with-presentation")
        binary = shutil.which("akatsuki-transcode")
    ...
    def _make_item(self, paths):
        ...
        item = Nautilus.MenuItem(
            name="AkatsukiTranscodeNautilus::transcode",
            label=label,
    ...
    def _tools_available(self):
        return bool(
            shutil.which("akatsuki-launch-floating-terminal-with-presentation")
            and shutil.which("akatsuki-transcode")
        )
