if command -v limine &>/dev/null; then
  sudo tee /etc/mkinitcpio.conf.d/akatsuki_hooks.conf <<EOF >/dev/null
...
EOF
  ...
  sudo cp $AKATSUKI_PATH/default/limine/default.conf /etc/default/limine
  ...
  sudo cp $AKATSUKI_PATH/default/limine/limine.conf /boot/limine.conf
  ...
  sudo cp $AKATSUKI_PATH/default/snapper/root /etc/snapper/configs/root
