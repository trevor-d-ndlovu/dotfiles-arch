...
mkdir -p ~/.config/akatsuki/themes
...
ln -snf ~/.config/akatsuki/current/theme/btop.theme ~/.config/btop/themes/current.theme

mkdir -p ~/.config/mako
ln -snf ~/.config/akatsuki/current/theme/mako.ini ~/.config/mako/config
