...
if akatsuki-hw-dell-xps-haptic-touchpad; then
  ...
  sudo rm -f /etc/akatsuki-dell-haptic-touchpad.env
  sudo systemctl daemon-reload
  sudo udevadm control --reload-rules

  source "$AKATSUKI_PATH/install/packaging/dell-xps-touchpad-haptics.sh"
fi
